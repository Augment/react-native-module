...
- (id<AGTAugmentPlayer>) augmentPlayer {
    return _arView.augmentPlayer;
}
...
- (void) addToARView: (id<AGTProduct>) augmentProduct {
    ...
    [ReactAugmentManager.augmentSDK addProduct:augmentProduct toAugmentPlayer:self.augmentPlayer progress:^(NSProgress* _Nonnull progress) {
        // Progress callback
